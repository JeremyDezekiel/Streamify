        ...
        <div className="mt-[1%] mx-[6%]">
            ...
            '>
                <div className="lg:w-[350px] xl:w-[450px] 2xl:[550px]">
                    ...
                    " src={`https://image.tmdb.org/t/p/original/${details.poster_path}`} alt={details.name} />
                </div>
                    ...
                    <div>
                        ...
                        '>
                            ...
                            <li className='flex items-center font-semibold bg-gray-600 rounded cursor-pointer hover:bg-gray-500 
                                        ...
                                        xl:py-1 xl:px-2
                                        2xl:py-2
                            ' onClick={() => goToTrailer(idMovie)}>
                                <img className="w-3
                                                md:w-4
                                                lg:w-5
                                                xl:w-6
                                                2xl:w-7
                                " src={iconPlayWhite} alt='iconPlayWhite' />
                            ...
                            <li>
                                <a>
                                    <img className="cursor-pointer hover:bg-red-700 
                                                    ...
                                                    xl:w-7
                                                    2xl:w-8
                                    " src={favoriteIcon} alt='favoriteIcon' />
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        return (
                            <div key={credits.id}>
                                <img className="rounded-md max-w-64
                                                ...
                                                xl:w-[215px] 
                                                2xl:w-[253px]
                            " src={`https://image.tmdb.org/t/p/w500/${credits.profile_path}`} alt={credits.name} />
                        ...
                        return (
                            <div key={credits.id}>
                                <img className="rounded-md max-w-56
                                                ...
                                                xl:w-[215px]
                                                2xl:w-[253px]
                                "src={avatarNone} alt={credits.name} />
                                <p className="font-bold tracking-tight
                                            text-sm
                                            md:text-lg
                                            lg:text-xl 
